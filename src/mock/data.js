...
export const aboutData = {
  ...
  paragraphThree:
    'On May 16, 2020, I finally earned my Full Stack, Developer Certification at freeCodeCamp.org after completing more than 1800 hours of coursework and submitting 30 projects ranging from "Responsive Web Design" to "Information Security and Quality Assurance". I regularly build my side projects and explore different web development stacks outside of work.',
  resume: 'https://drive.google.com/file/d/12bMWculwJMJUapKf3dhfH-TqOJZoqdid/view?usp=sharing', // if no resume, the button will not show up
};
